...
{
    /// <summary>
    /// Export PDF report action resource
    /// </summary>
    [DataContract]
        public partial class ExportPdfReportResource :  IEquatable<ExportPdfReportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportPdfReportResource" /> class.
        /// </summary>
        ...
        public ExportPdfReportResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportPdfReportResource {\n");
        ...
        {
            return this.Equals(input as ExportPdfReportResource);
        }

        /// <summary>
        /// Returns true if ExportPdfReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportPdfReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportPdfReportResource input)
        {
            if (input == null)
                return false;
