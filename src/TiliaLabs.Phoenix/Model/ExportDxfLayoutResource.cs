...
{
    /// <summary>
    /// Export DXF layout action resource
    /// </summary>
    [DataContract]
        public partial class ExportDxfLayoutResource :  IEquatable<ExportDxfLayoutResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportDxfLayoutResource" /> class.
        /// </summary>
        ...
        public ExportDxfLayoutResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportDxfLayoutResource {\n");
        ...
        {
            return this.Equals(input as ExportDxfLayoutResource);
        }

        /// <summary>
        /// Returns true if ExportDxfLayoutResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportDxfLayoutResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportDxfLayoutResource input)
        {
            if (input == null)
                return false;
