...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MediaRules :  IEquatable<MediaRules>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaRules" /> class.
        /// </summary>
        /// <param name="_default">_default (required).</param>
        /// <param name="map">Map containing key/values.</param>
        /// <param name="type">type (required).</param>
        public MediaRules(MediaRule _default = default(MediaRule), Dictionary<string, MediaRule> map = default(Dictionary<string, MediaRule>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "_default" is required (not null)
            if (_default == null)
            {
                throw new InvalidDataException("_default is a required property for MediaRules and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for MediaRules and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as MediaRules);
        }

        /// <summary>
        /// Returns true if MediaRules instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaRules input)
        {
            if (input == null)
                return false;
