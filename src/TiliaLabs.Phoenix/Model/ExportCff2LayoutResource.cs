...
{
    /// <summary>
    /// Export CFF2 layout action resource
    /// </summary>
    [DataContract]
        public partial class ExportCff2LayoutResource :  IEquatable<ExportCff2LayoutResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportCff2LayoutResource" /> class.
        /// </summary>
        ...
        public ExportCff2LayoutResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportCff2LayoutResource {\n");
        ...
        {
            return this.Equals(input as ExportCff2LayoutResource);
        }

        /// <summary>
        /// Returns true if ExportCff2LayoutResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportCff2LayoutResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportCff2LayoutResource input)
        {
            if (input == null)
                return false;
