...
{
    /// <summary>
    /// Roll-fed Wide Format Press Result
    /// </summary>
    [DataContract]
        public partial class RfwfpResult :  IEquatable<RfwfpResult>, IValidatableObject
    {
        /// <summary>
        /// Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RfwfpResult" /> class.
        /// </summary>
        ...
        public RfwfpResult(StatusEnum status = default(StatusEnum), List<string> processes = default(List<string>), TimeInfo time = default(TimeInfo), CostInfo cost = default(CostInfo), List<Message> messages = default(List<Message>), List<Message> externalMessages = default(List<Message>), string processType = default(string), TimeInfo setupTime = default(TimeInfo), int? totalLayouts = default(int?), int? setupLayouts = default(int?), int? wasteLayouts = default(int?), List<PressColor> colors = default(List<PressColor>), SideEnum? side = default(SideEnum?), CostInfo inkCost = default(CostInfo), TypeEnum type = default(TypeEnum))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for RfwfpResult and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RfwfpResult and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as RfwfpResult);
        }

        /// <summary>
        /// Returns true if RfwfpResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RfwfpResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RfwfpResult input)
        {
            if (input == null)
                return false;
