...
{
    /// <summary>
    /// Digital cutting table operation
    /// </summary>
    [DataContract]
        public partial class DctOperation :  IEquatable<DctOperation>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DctOperation" /> class.
        /// </summary>
        /// <param name="_default">_default (required).</param>
        /// <param name="map">Map containing key/values.</param>
        /// <param name="type">type (required).</param>
        public DctOperation(DctRuleValue _default = default(DctRuleValue), Dictionary<string, DctRuleValue> map = default(Dictionary<string, DctRuleValue>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "_default" is required (not null)
            if (_default == null)
            {
                throw new InvalidDataException("_default is a required property for DctOperation and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DctOperation and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public DctRuleValue _Default { get; set; }
        ...
        public Dictionary<string, DctRuleValue> Map { get; set; }
        ...
        {
            return this.Equals(input as DctOperation);
        }

        /// <summary>
        /// Returns true if DctOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of DctOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DctOperation input)
        {
            if (input == null)
                return false;
