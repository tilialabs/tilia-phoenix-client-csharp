...
namespace TiliaLabs.Phoenix.Model
{
        ...
        public partial class Process :  IEquatable<Process>, IValidatableObject
    {
        ...
        public Process(string name = default(string), string description = default(string), string notes = default(string), string externalId = default(string), List<PropertyObject> properties = default(List<PropertyObject>), string path = default(string))
        {
