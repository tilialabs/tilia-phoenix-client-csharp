...
{
    /// <summary>
    /// Export PDF action resource
    /// </summary>
    [DataContract]
        public partial class ExportPdfResource :  IEquatable<ExportPdfResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportPdfResource" /> class.
        /// </summary>
        ...
        public ExportPdfResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportPdfResource {\n");
        ...
        {
            return this.Equals(input as ExportPdfResource);
        }

        /// <summary>
        /// Returns true if ExportPdfResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportPdfResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportPdfResource input)
        {
            if (input == null)
                return false;
