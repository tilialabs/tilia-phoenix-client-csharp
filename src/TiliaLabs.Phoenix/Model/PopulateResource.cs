...
{
    /// <summary>
    /// Populate action resource
    /// </summary>
    [DataContract]
        public partial class PopulateResource :  IEquatable<PopulateResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PopulateResource" /> class.
        /// </summary>
        ...
        public PopulateResource(int? idref = default(int?), List<string> products = default(List<string>), List<string> profiles = default(List<string>), List<ImpositionAiProfileEntity> profilesInline = default(List<ImpositionAiProfileEntity>), int? stopMinutes = default(int?))
        {
            this.Idref = idref;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PopulateResource {\n");
        ...
        {
            return this.Equals(input as PopulateResource);
        }

        /// <summary>
        /// Returns true if PopulateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PopulateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PopulateResource input)
        {
            if (input == null)
                return false;
