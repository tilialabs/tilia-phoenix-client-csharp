...
{
    /// <summary>
    /// Export JSON report action resource
    /// </summary>
    [DataContract]
        public partial class ExportJsonReportResource :  IEquatable<ExportJsonReportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportJsonReportResource" /> class.
        /// </summary>
        ...
        public ExportJsonReportResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportJsonReportResource {\n");
        ...
        {
            return this.Equals(input as ExportJsonReportResource);
        }

        /// <summary>
        /// Returns true if ExportJsonReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportJsonReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportJsonReportResource input)
        {
            if (input == null)
                return false;
