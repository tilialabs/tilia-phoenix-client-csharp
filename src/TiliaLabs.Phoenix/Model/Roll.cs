...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Roll :  IEquatable<Roll>, IValidatableObject
    {
        /// <summary>
        ...
        public Roll(string description = default(string), string notes = default(string), string externalId = default(string), double? cost = default(double?), CostUnitsEnum? costUnits = default(CostUnitsEnum?), TypeEnum type = default(TypeEnum), List<PropertyObject> properties = default(List<PropertyObject>), string path = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Roll and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// <summary>
        /// Read-only roll name derived from the width of the roll
        /// </summary>
        /// <value>Read-only roll name derived from the width of the roll</value>
        ...
        {
            return this.Equals(input as Roll);
        }

        /// <summary>
        /// Returns true if Roll instances are equal
        /// </summary>
        /// <param name="input">Instance of Roll to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Roll input)
        {
            if (input == null)
                return false;
