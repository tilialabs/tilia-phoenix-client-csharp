...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OperationModes :  IEquatable<OperationModes>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationModes" /> class.
        /// </summary>
        /// <param name="_default">_default (required).</param>
        /// <param name="map">Map containing key/values.</param>
        /// <param name="type">type (required).</param>
        public OperationModes(OperationMode _default = default(OperationMode), Dictionary<string, OperationMode> map = default(Dictionary<string, OperationMode>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "_default" is required (not null)
            if (_default == null)
            {
                throw new InvalidDataException("_default is a required property for OperationModes and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for OperationModes and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public OperationMode _Default { get; set; }
        ...
        public Dictionary<string, OperationMode> Map { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OperationModes {\n");
        ...
        {
            return this.Equals(input as OperationModes);
        }

        /// <summary>
        /// Returns true if OperationModes instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationModes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationModes input)
        {
            if (input == null)
                return false;
