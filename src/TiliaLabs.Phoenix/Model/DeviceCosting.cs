...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeviceCosting :  IEquatable<DeviceCosting>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceCosting" /> class.
        /// </summary>
        /// <param name="currency">currency (required).</param>
        /// <param name="rate">rate (required).</param>
        /// <param name="setup">setup (required).</param>
        /// <param name="type">type (required).</param>
        public DeviceCosting(DctcostingCurrency currency = default(DctcostingCurrency), Rate rate = default(Rate), Setup setup = default(Setup), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for DeviceCosting and cannot be null");
            }
            else
            {
            ...
            if (rate == null)
            {
                throw new InvalidDataException("rate is a required property for DeviceCosting and cannot be null");
            }
            else
            {
                this.Rate = rate;
            ...
            if (setup == null)
            {
                throw new InvalidDataException("setup is a required property for DeviceCosting and cannot be null");
            }
            else
            {
                this.Setup = setup;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DeviceCosting and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as DeviceCosting);
        }

        /// <summary>
        /// Returns true if DeviceCosting instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceCosting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceCosting input)
        {
            if (input == null)
                return false;
