...
{
    /// <summary>
    /// Guillotine cutter capabilities
    /// </summary>
    [DataContract]
        public partial class GcCapabilities :  IEquatable<GcCapabilities>, IValidatableObject
    {
        /// <summary>
        /// Limit logic
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GcCapabilities" /> class.
        /// </summary>
        ...
        public GcCapabilities(ScalarRange widthRange = default(ScalarRange), ScalarRange heightRange = default(ScalarRange), bool? limit = default(bool?), LimitLogicEnum limitLogic = default(LimitLogicEnum), ScalarRange caliperRange = default(ScalarRange), StockWeightRange weightRange = default(StockWeightRange), SheetHandlingEnum sheetHandling = default(SheetHandlingEnum), DctcapabilitiesStocktypes stockTypes = default(DctcapabilitiesStocktypes), DctcapabilitiesStocktypes specificStocks = default(DctcapabilitiesStocktypes), TypeEnum type = default(TypeEnum))
        {
            ...
            if (heightRange == null)
            {
                throw new InvalidDataException("heightRange is a required property for GcCapabilities and cannot be null");
            }
            else
            {
            ...
            if (limit == null)
            {
                throw new InvalidDataException("limit is a required property for GcCapabilities and cannot be null");
            }
            else
            {
                this.Limit = limit;
            ...
            if (limitLogic == null)
            {
                throw new InvalidDataException("limitLogic is a required property for GcCapabilities and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("caliperRange is a required property for GcCapabilities and cannot be null");
            }
            else
            {
            ...
            if (weightRange == null)
            {
                throw new InvalidDataException("weightRange is a required property for GcCapabilities and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sheetHandling is a required property for GcCapabilities and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GcCapabilities and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GcCapabilities {\n");
        ...
        {
            return this.Equals(input as GcCapabilities);
        }

        /// <summary>
        /// Returns true if GcCapabilities instances are equal
        /// </summary>
        /// <param name="input">Instance of GcCapabilities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcCapabilities input)
        {
            if (input == null)
                return false;
