...
{
    /// <summary>
    /// Export JDF HP action resource
    /// </summary>
    [DataContract]
        public partial class ExportHpJdfResource :  IEquatable<ExportHpJdfResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportHpJdfResource" /> class.
        /// </summary>
        ...
        public ExportHpJdfResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportHpJdfResource {\n");
        ...
        {
            return this.Equals(input as ExportHpJdfResource);
        }

        /// <summary>
        /// Returns true if ExportHpJdfResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportHpJdfResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportHpJdfResource input)
        {
            if (input == null)
                return false;
