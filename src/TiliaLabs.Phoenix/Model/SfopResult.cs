...
{
    /// <summary>
    /// Sheet-fed Offset Press Result
    /// </summary>
    [DataContract]
        public partial class SfopResult :  IEquatable<SfopResult>, IValidatableObject
    {
        /// <summary>
        /// Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SfopResult" /> class.
        /// </summary>
        ...
        /// <param name="plateCost">plateCost.</param>
        /// <param name="plates">Plate count.</param>
        /// <param name="type">type (required).</param>
        public SfopResult(StatusEnum status = default(StatusEnum), List<string> processes = default(List<string>), TimeInfo time = default(TimeInfo), CostInfo cost = default(CostInfo), List<Message> messages = default(List<Message>), List<Message> externalMessages = default(List<Message>), string processType = default(string), TimeInfo setupTime = default(TimeInfo), int? totalLayouts = default(int?), int? setupLayouts = default(int?), int? wasteLayouts = default(int?), List<PressColor> colors = default(List<PressColor>), SideEnum? side = default(SideEnum?), CostInfo inkCost = default(CostInfo), CostInfo plateCost = default(CostInfo), int? plates = default(int?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for SfopResult and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for SfopResult and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// <summary>
        /// Gets or Sets PlateCost
        /// </summary>
        [DataMember(Name="plate-cost", EmitDefaultValue=false)]
        public CostInfo PlateCost { get; set; }

        /// <summary>
        /// Plate count
        /// </summary>
        /// <value>Plate count</value>
        ...
        {
            return this.Equals(input as SfopResult);
        }

        /// <summary>
        /// Returns true if SfopResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SfopResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SfopResult input)
        {
            if (input == null)
                return false;
