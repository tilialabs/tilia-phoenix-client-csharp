...
{
    /// <summary>
    /// Export cutting JDF action resource
    /// </summary>
    [DataContract]
        public partial class ExportCuttingJdfResource :  IEquatable<ExportCuttingJdfResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportCuttingJdfResource" /> class.
        /// </summary>
        ...
        public ExportCuttingJdfResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportCuttingJdfResource {\n");
        ...
        {
            return this.Equals(input as ExportCuttingJdfResource);
        }

        /// <summary>
        /// Returns true if ExportCuttingJdfResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportCuttingJdfResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportCuttingJdfResource input)
        {
            if (input == null)
                return false;
