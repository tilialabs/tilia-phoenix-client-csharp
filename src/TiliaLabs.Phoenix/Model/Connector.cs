...
{
    /// <summary>
    /// Connector to link things together
    /// </summary>
    [DataContract]
        public partial class Connector :  IEquatable<Connector>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="thing">thing (required).</param>
        public Connector(Reference thing = default(Reference))
        {
            // to ensure "thing" is required (not null)
            if (thing == null)
            {
                throw new InvalidDataException("thing is a required property for Connector and cannot be null");
            }
            else
            {
                this.Thing = thing;
        ...
        public Reference Thing { get; set; }
