...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Spacing :  IEquatable<Spacing>, IValidatableObject
    {
        /// <summary>
        /// Type
        /// </summary>
        ...
        public Spacing(TypeEnum type = default(TypeEnum), string margin = default(string), Margins margins = default(Margins))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Spacing and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as Spacing);
        }

        /// <summary>
        /// Returns true if Spacing instances are equal
        /// </summary>
        /// <param name="input">Instance of Spacing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Spacing input)
        {
            if (input == null)
                return false;
