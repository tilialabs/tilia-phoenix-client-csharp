...
{
    /// <summary>
    /// Export Tiling report action resource
    /// </summary>
    [DataContract]
        public partial class ExportTilingReportResource :  IEquatable<ExportTilingReportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportTilingReportResource" /> class.
        /// </summary>
        ...
        public ExportTilingReportResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportTilingReportResource {\n");
        ...
        {
            return this.Equals(input as ExportTilingReportResource);
        }

        /// <summary>
        /// Returns true if ExportTilingReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportTilingReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportTilingReportResource input)
        {
            if (input == null)
                return false;
