...
{
    /// <summary>
    /// Guillotine cutter processing results
    /// </summary>
    [DataContract]
        public partial class GcResult :  IEquatable<GcResult>, IValidatableObject
    {
        /// <summary>
        /// Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GcResult" /> class.
        /// </summary>
        ...
        /// <param name="sheetTurns">Number of sheet turns (required).</param>
        /// <param name="stacks">Number of stacks that need to be cut (required).</param>
        /// <param name="type">type (required).</param>
        public GcResult(StatusEnum status = default(StatusEnum), List<string> processes = default(List<string>), TimeInfo time = default(TimeInfo), CostInfo cost = default(CostInfo), List<Message> messages = default(List<Message>), List<Message> externalMessages = default(List<Message>), string processType = default(string), TimeInfo setupTime = default(TimeInfo), int? totalLayouts = default(int?), int? sheetTurns = default(int?), int? stacks = default(int?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for GcResult and cannot be null");
            }
            else
            {
                this.Status = status;
            }
            // to ensure "sheetTurns" is required (not null)
            if (sheetTurns == null)
            {
                throw new InvalidDataException("sheetTurns is a required property for GcResult and cannot be null");
            }
            else
            {
                this.SheetTurns = sheetTurns;
            }
            // to ensure "stacks" is required (not null)
            if (stacks == null)
            {
                throw new InvalidDataException("stacks is a required property for GcResult and cannot be null");
            }
            else
            {
                this.Stacks = stacks;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GcResult and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// <summary>
        /// Number of sheet turns
        /// </summary>
        /// <value>Number of sheet turns</value>
        [DataMember(Name="sheet-turns", EmitDefaultValue=false)]
        public int? SheetTurns { get; set; }

        /// <summary>
        /// Number of stacks that need to be cut
        /// </summary>
        /// <value>Number of stacks that need to be cut</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SheetTurns: ").Append(SheetTurns).Append("\n");
        ...
        {
            return this.Equals(input as GcResult);
        }

        /// <summary>
        /// Returns true if GcResult instances are equal
        /// </summary>
        /// <param name="input">Instance of GcResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcResult input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SheetTurns == input.SheetTurns ||
                    (this.SheetTurns != null &&
                    this.SheetTurns.Equals(input.SheetTurns))
                ) && 
                (
                    this.Stacks == input.Stacks ||
                    (this.Stacks != null &&
                    this.Stacks.Equals(input.Stacks))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SheetTurns != null)
                    hashCode = hashCode * 59 + this.SheetTurns.GetHashCode();
                if (this.Stacks != null)
