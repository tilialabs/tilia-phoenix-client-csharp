...
{
    /// <summary>
    /// Export JDF action resource
    /// </summary>
    [DataContract]
        public partial class ExportJdfResource :  IEquatable<ExportJdfResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportJdfResource" /> class.
        /// </summary>
        ...
        public ExportJdfResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportJdfResource {\n");
        ...
        {
            return this.Equals(input as ExportJdfResource);
        }

        /// <summary>
        /// Returns true if ExportJdfResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportJdfResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportJdfResource input)
        {
            if (input == null)
                return false;
