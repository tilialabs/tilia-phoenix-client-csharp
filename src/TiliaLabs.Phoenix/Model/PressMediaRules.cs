...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PressMediaRules :  IEquatable<PressMediaRules>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PressMediaRules" /> class.
        /// </summary>
        /// <param name="_default">_default (required).</param>
        /// <param name="map">Map containing key/values.</param>
        /// <param name="type">type (required).</param>
        public PressMediaRules(PressMediaRule _default = default(PressMediaRule), Dictionary<string, PressMediaRule> map = default(Dictionary<string, PressMediaRule>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "_default" is required (not null)
            if (_default == null)
            {
                throw new InvalidDataException("_default is a required property for PressMediaRules and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PressMediaRules and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public PressMediaRule _Default { get; set; }
        ...
        public Dictionary<string, PressMediaRule> Map { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PressMediaRules {\n");
        ...
        {
            return this.Equals(input as PressMediaRules);
        }

        /// <summary>
        /// Returns true if PressMediaRules instances are equal
        /// </summary>
        /// <param name="input">Instance of PressMediaRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PressMediaRules input)
        {
            if (input == null)
                return false;
