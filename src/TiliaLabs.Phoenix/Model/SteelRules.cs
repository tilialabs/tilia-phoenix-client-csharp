...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SteelRules :  IEquatable<SteelRules>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SteelRules" /> class.
        /// </summary>
        /// <param name="_default">_default (required).</param>
        /// <param name="map">Map containing key/values.</param>
        /// <param name="type">type (required).</param>
        public SteelRules(SteelRule _default = default(SteelRule), Dictionary<string, SteelRule> map = default(Dictionary<string, SteelRule>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "_default" is required (not null)
            if (_default == null)
            {
                throw new InvalidDataException("_default is a required property for SteelRules and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for SteelRules and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public SteelRule _Default { get; set; }
        ...
        public Dictionary<string, SteelRule> Map { get; set; }
        ...
        {
            return this.Equals(input as SteelRules);
        }

        /// <summary>
        /// Returns true if SteelRules instances are equal
        /// </summary>
        /// <param name="input">Instance of SteelRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SteelRules input)
        {
            if (input == null)
                return false;
