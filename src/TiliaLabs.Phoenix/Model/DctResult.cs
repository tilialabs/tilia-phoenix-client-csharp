...
{
    /// <summary>
    /// Digital cutting table processing results
    /// </summary>
    [DataContract]
        public partial class DctResult :  IEquatable<DctResult>, IValidatableObject
    {
        /// <summary>
        /// Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DctResult" /> class.
        /// </summary>
        ...
        /// <param name="runLength">Run length (required).</param>
        /// <param name="toolStats">Tool stats.</param>
        /// <param name="type">type (required).</param>
        public DctResult(StatusEnum status = default(StatusEnum), List<string> processes = default(List<string>), TimeInfo time = default(TimeInfo), CostInfo cost = default(CostInfo), List<Message> messages = default(List<Message>), List<Message> externalMessages = default(List<Message>), string processType = default(string), TimeInfo setupTime = default(TimeInfo), int? totalLayouts = default(int?), int? runLength = default(int?), List<DctToolStats> toolStats = default(List<DctToolStats>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for DctResult and cannot be null");
            }
            else
            {
                this.Status = status;
            }
            // to ensure "runLength" is required (not null)
            if (runLength == null)
            {
                throw new InvalidDataException("runLength is a required property for DctResult and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DctResult and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// Tool stats
        /// </summary>
        /// <value>Tool stats</value>
        [DataMember(Name="tool-stats", EmitDefaultValue=false)]
        public List<DctToolStats> ToolStats { get; set; }
        ...
        {
            return this.Equals(input as DctResult);
        }

        /// <summary>
        /// Returns true if DctResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DctResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DctResult input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.ToolStats != null &&
                    input.ToolStats != null &&
                    this.ToolStats.SequenceEqual(input.ToolStats)
                ) && 
                (
