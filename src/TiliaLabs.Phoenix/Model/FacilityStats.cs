...
{
    /// <summary>
    /// Facility-level aggregate stats
    /// </summary>
    [DataContract]
        public partial class FacilityStats :  IEquatable<FacilityStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FacilityStats" /> class.
        /// </summary>
        ...
        public FacilityStats(TimeInfo time = default(TimeInfo), CostInfo cost = default(CostInfo), List<ProcessStats> processStats = default(List<ProcessStats>), int? totalLayouts = default(int?), int? setupLayouts = default(int?), int? wasteLayouts = default(int?))
        {
            // to ensure "time" is required (not null)
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for FacilityStats and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (cost == null)
            {
                throw new InvalidDataException("cost is a required property for FacilityStats and cannot be null");
            }
            else
            {
                this.Cost = cost;
        ...
        {
            return this.Equals(input as FacilityStats);
        }

        /// <summary>
        /// Returns true if FacilityStats instances are equal
        /// </summary>
        /// <param name="input">Instance of FacilityStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FacilityStats input)
        {
            if (input == null)
                return false;
