...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DoubleProperty : PropertyObject, IEquatable<DoubleProperty>, IValidatableObject
    {
        /// <summary>
        /// Gets Type
        /// </summary>
        ...
        public DoubleProperty(string name = default(string), double? value = default(double?)) : base(name)
        {
            Value = value;
        }
