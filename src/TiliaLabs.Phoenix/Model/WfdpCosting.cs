...
{
    /// <summary>
    /// Web-fed Digital Press Costing
    /// </summary>
    [DataContract]
        public partial class WfdpCosting :  IEquatable<WfdpCosting>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WfdpCosting" /> class.
        /// </summary>
        ...
        public WfdpCosting(DctcostingCurrency currency = default(DctcostingCurrency), Rate rate = default(Rate), SetupLayouts setup = default(SetupLayouts), double? runningWaste = default(double?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for WfdpCosting and cannot be null");
            }
            else
            {
            ...
            if (rate == null)
            {
                throw new InvalidDataException("rate is a required property for WfdpCosting and cannot be null");
            }
            else
            {
                this.Rate = rate;
            ...
            if (setup == null)
            {
                throw new InvalidDataException("setup is a required property for WfdpCosting and cannot be null");
            }
            else
            {
                this.Setup = setup;
            ...
            {
                throw new InvalidDataException("runningWaste is a required property for WfdpCosting and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for WfdpCosting and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as WfdpCosting);
        }

        /// <summary>
        /// Returns true if WfdpCosting instances are equal
        /// </summary>
        /// <param name="input">Instance of WfdpCosting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfdpCosting input)
        {
            if (input == null)
                return false;
