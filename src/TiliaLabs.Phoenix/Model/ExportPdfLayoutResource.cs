...
{
    /// <summary>
    /// Export PDF layout action resource
    /// </summary>
    [DataContract]
        public partial class ExportPdfLayoutResource :  IEquatable<ExportPdfLayoutResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportPdfLayoutResource" /> class.
        /// </summary>
        ...
        public ExportPdfLayoutResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportPdfLayoutResource {\n");
        ...
        {
            return this.Equals(input as ExportPdfLayoutResource);
        }

        /// <summary>
        /// Returns true if ExportPdfLayoutResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportPdfLayoutResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportPdfLayoutResource input)
        {
            if (input == null)
                return false;
