...
{
    /// <summary>
    /// Web-fed Offset Press Result
    /// </summary>
    [DataContract]
        public partial class WfopResult :  IEquatable<WfopResult>, IValidatableObject
    {
        /// <summary>
        /// Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WfopResult" /> class.
        /// </summary>
        ...
        public WfopResult(StatusEnum status = default(StatusEnum), List<string> processes = default(List<string>), TimeInfo time = default(TimeInfo), CostInfo cost = default(CostInfo), List<Message> messages = default(List<Message>), List<Message> externalMessages = default(List<Message>), string processType = default(string), TimeInfo setupTime = default(TimeInfo), int? totalLayouts = default(int?), int? setupLayouts = default(int?), int? wasteLayouts = default(int?), List<PressColor> colors = default(List<PressColor>), SideEnum? side = default(SideEnum?), CostInfo inkCost = default(CostInfo), CostInfo plateCost = default(CostInfo), int? plates = default(int?), TypeEnum type = default(TypeEnum))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for WfopResult and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as WfopResult);
        }

        /// <summary>
        /// Returns true if WfopResult instances are equal
        /// </summary>
        /// <param name="input">Instance of WfopResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfopResult input)
        {
            if (input == null)
                return false;
