...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MarkEntity :  IEquatable<MarkEntity>, IValidatableObject
    {
        /// <summary>
        /// Smart mark anchor
        /// </summary>
        /// <value>Smart mark anchor</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkEntity" /> class.
        /// </summary>
        ...
        /// <param name="smart">Whether mark is smart or manual.</param>
        /// <param name="anchor">Smart mark anchor.</param>
        public MarkEntity(string name = default(string), string id = default(string), string externalId = default(string), string description = default(string), bool? smart = default(bool?), AnchorEnum? anchor = default(AnchorEnum?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for MarkEntity and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// <summary>
        /// Whether mark is smart or manual
        /// </summary>
        /// <value>Whether mark is smart or manual</value>
        ...
        {
            return this.Equals(input as MarkEntity);
        }

        /// <summary>
        /// Returns true if MarkEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of MarkEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarkEntity input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Smart == input.Smart ||
                    (this.Smart != null &&
                    this.Smart.Equals(input.Smart))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Smart != null)
                    hashCode = hashCode * 59 + this.Smart.GetHashCode();
                if (this.Anchor != null)
