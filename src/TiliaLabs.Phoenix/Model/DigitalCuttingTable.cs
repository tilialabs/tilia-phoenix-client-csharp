...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DigitalCuttingTable :  IEquatable<DigitalCuttingTable>, IValidatableObject
    {
        /// <summary>
        /// Estimating engine
        /// </summary>
        /// <value>Estimating engine</value>
        [JsonConverter(typeof(StringEnumConverter))]
                public enum EstimatingEngineEnum
        {
            /// <summary>
            /// Enum TiliaLabs for value: Tilia Labs
            /// </summary>
            [EnumMember(Value = "Tilia Labs")]
            TiliaLabs = 1,
            /// <summary>
            /// Enum ZundCutCenter for value: Zund Cut Center
            /// </summary>
            [EnumMember(Value = "Zund Cut Center")]
            ZundCutCenter = 2        }
        /// <summary>
        /// Estimating engine
        /// </summary>
        /// <value>Estimating engine</value>
        [DataMember(Name="estimating-engine", EmitDefaultValue=false)]
        public EstimatingEngineEnum EstimatingEngine { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DigitalCuttingTable" /> class.
        /// </summary>
        ...
        /// <param name="estimatingEngine">Estimating engine (required).</param>
        /// <param name="zccConnectionSettings">zccConnectionSettings.</param>
        ...
        public DigitalCuttingTable(string name = default(string), string description = default(string), string notes = default(string), string externalId = default(string), bool? allowPassThrough = default(bool?), List<Connector> connections = default(List<Connector>), DctCosting costing = default(DctCosting), DctCapabilities capabilities = default(DctCapabilities), Reference script = default(Reference), string manufacturer = default(string), DctMediaRules mediaRules = default(DctMediaRules), Placement placement = default(Placement), DctOperation operation = default(DctOperation), EstimatingEngineEnum estimatingEngine = default(EstimatingEngineEnum), ZccConnectionSettings zccConnectionSettings = default(ZccConnectionSettings), ProcessType processType = default(ProcessType), FeedTypeEnum feedType = default(FeedTypeEnum), TypeEnum type = default(TypeEnum), List<PropertyObject> properties = default(List<PropertyObject>), string path = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (costing == null)
            {
                throw new InvalidDataException("costing is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("capabilities is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("manufacturer is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
            ...
            if (mediaRules == null)
            {
                throw new InvalidDataException("mediaRules is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
            ...
            if (placement == null)
            {
                throw new InvalidDataException("placement is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
            ...
            if (operation == null)
            {
                throw new InvalidDataException("operation is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
                this.Operation = operation;
            }
            // to ensure "estimatingEngine" is required (not null)
            if (estimatingEngine == null)
            {
                throw new InvalidDataException("estimatingEngine is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
                this.EstimatingEngine = estimatingEngine;
            }
            // to ensure "processType" is required (not null)
            if (processType == null)
            {
                throw new InvalidDataException("processType is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
            ...
            if (feedType == null)
            {
                throw new InvalidDataException("feedType is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DigitalCuttingTable and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            this.Script = script;
            this.ZccConnectionSettings = zccConnectionSettings;
        ...
        public DctCosting Costing { get; set; }

        /// <summary>
        /// Gets or Sets Capabilities
        /// </summary>
        [DataMember(Name="capabilities", EmitDefaultValue=false)]
        public DctCapabilities Capabilities { get; set; }
        ...
        public DctMediaRules MediaRules { get; set; }
        ...
        public DctOperation Operation { get; set; }


        /// <summary>
        /// Gets or Sets ZccConnectionSettings
        /// </summary>
        [DataMember(Name="zcc-connection-settings", EmitDefaultValue=false)]
        public ZccConnectionSettings ZccConnectionSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DigitalCuttingTable {\n");
            ...
            sb.Append("  EstimatingEngine: ").Append(EstimatingEngine).Append("\n");
            sb.Append("  ZccConnectionSettings: ").Append(ZccConnectionSettings).Append("\n");
        ...
        {
            return this.Equals(input as DigitalCuttingTable);
        }

        /// <summary>
        /// Returns true if DigitalCuttingTable instances are equal
        /// </summary>
        /// <param name="input">Instance of DigitalCuttingTable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DigitalCuttingTable input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EstimatingEngine == input.EstimatingEngine ||
                    (this.EstimatingEngine != null &&
                    this.EstimatingEngine.Equals(input.EstimatingEngine))
                ) && 
                (
                    this.ZccConnectionSettings == input.ZccConnectionSettings ||
                    (this.ZccConnectionSettings != null &&
                    this.ZccConnectionSettings.Equals(input.ZccConnectionSettings))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EstimatingEngine != null)
                    hashCode = hashCode * 59 + this.EstimatingEngine.GetHashCode();
                if (this.ZccConnectionSettings != null)
                    hashCode = hashCode * 59 + this.ZccConnectionSettings.GetHashCode();
