...
{
    /// <summary>
    /// Web-fed Digital Press Result
    /// </summary>
    [DataContract]
        public partial class WfdpResult :  IEquatable<WfdpResult>, IValidatableObject
    {
        /// <summary>
        /// Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WfdpResult" /> class.
        /// </summary>
        ...
        public WfdpResult(StatusEnum status = default(StatusEnum), List<string> processes = default(List<string>), TimeInfo time = default(TimeInfo), CostInfo cost = default(CostInfo), List<Message> messages = default(List<Message>), List<Message> externalMessages = default(List<Message>), string processType = default(string), TimeInfo setupTime = default(TimeInfo), int? totalLayouts = default(int?), int? setupLayouts = default(int?), int? wasteLayouts = default(int?), List<PressColor> colors = default(List<PressColor>), SideEnum? side = default(SideEnum?), CostInfo inkCost = default(CostInfo), TypeEnum type = default(TypeEnum))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for WfdpResult and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for WfdpResult and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as WfdpResult);
        }

        /// <summary>
        /// Returns true if WfdpResult instances are equal
        /// </summary>
        /// <param name="input">Instance of WfdpResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WfdpResult input)
        {
            if (input == null)
                return false;
