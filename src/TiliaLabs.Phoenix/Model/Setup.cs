...
namespace TiliaLabs.Phoenix.Model
{
        ...
        public partial class Setup :  IEquatable<Setup>, IValidatableObject
    {
        ...
        public Setup(TimeValue time = default(TimeValue), TypeEnum type = default(TypeEnum))
        {
            // to ensure "time" is required (not null)
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for Setup and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Setup and cannot be null");
            }
            else
            {
                this.Type = type;
