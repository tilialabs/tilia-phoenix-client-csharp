...
namespace TiliaLabs.Phoenix.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PressCapabilities :  IEquatable<PressCapabilities>, IValidatableObject
    {
        /// <summary>
        /// Limit logic
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PressCapabilities" /> class.
        /// </summary>
        ...
        public PressCapabilities(ScalarRange widthRange = default(ScalarRange), ScalarRange heightRange = default(ScalarRange), bool? limit = default(bool?), LimitLogicEnum limitLogic = default(LimitLogicEnum), ScalarRange caliperRange = default(ScalarRange), StockWeightRange weightRange = default(StockWeightRange), SheetHandlingEnum sheetHandling = default(SheetHandlingEnum), DctcapabilitiesStocktypes stockTypes = default(DctcapabilitiesStocktypes), DctcapabilitiesStocktypes specificStocks = default(DctcapabilitiesStocktypes), TypeEnum type = default(TypeEnum))
        {
            ...
            if (heightRange == null)
            {
                throw new InvalidDataException("heightRange is a required property for PressCapabilities and cannot be null");
            }
            else
            {
            ...
            if (limit == null)
            {
                throw new InvalidDataException("limit is a required property for PressCapabilities and cannot be null");
            }
            else
            {
                this.Limit = limit;
            ...
            if (limitLogic == null)
            {
                throw new InvalidDataException("limitLogic is a required property for PressCapabilities and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("caliperRange is a required property for PressCapabilities and cannot be null");
            }
            else
            {
            ...
            if (weightRange == null)
            {
                throw new InvalidDataException("weightRange is a required property for PressCapabilities and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sheetHandling is a required property for PressCapabilities and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PressCapabilities and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PressCapabilities {\n");
        ...
        {
            return this.Equals(input as PressCapabilities);
        }

        /// <summary>
        /// Returns true if PressCapabilities instances are equal
        /// </summary>
        /// <param name="input">Instance of PressCapabilities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PressCapabilities input)
        {
            if (input == null)
                return false;
