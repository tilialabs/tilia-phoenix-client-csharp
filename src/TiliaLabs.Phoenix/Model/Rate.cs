...
namespace TiliaLabs.Phoenix.Model
{
        ...
        public partial class Rate :  IEquatable<Rate>, IValidatableObject
    {
        ...
        public Rate(double? value = default(double?), UnitsEnum units = default(UnitsEnum))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for Rate and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            if (units == null)
            {
                throw new InvalidDataException("units is a required property for Rate and cannot be null");
            }
            else
            {
                this.Units = units;
