...
{
    /// <summary>
    /// Export Zund Cut Center layout action resource
    /// </summary>
    [DataContract]
        public partial class ExportZccLayoutResource :  IEquatable<ExportZccLayoutResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportZccLayoutResource" /> class.
        /// </summary>
        ...
        public ExportZccLayoutResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportZccLayoutResource {\n");
        ...
        {
            return this.Equals(input as ExportZccLayoutResource);
        }

        /// <summary>
        /// Returns true if ExportZccLayoutResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportZccLayoutResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportZccLayoutResource input)
        {
            if (input == null)
                return false;
