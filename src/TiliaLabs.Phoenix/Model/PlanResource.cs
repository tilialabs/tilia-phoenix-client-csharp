...
{
    /// <summary>
    /// Plan tool settings including devices, sheets, rolls, and profiles to use during planning
    /// </summary>
    [DataContract]
        public partial class PlanResource :  IEquatable<PlanResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlanResource" /> class.
        /// </summary>
        ...
        /// <param name="things">Names of things to use during Plan.</param>
        /// <param name="sheets">Sheets to use during Plan.</param>
        /// <param name="rolls">Rolls to use during Plan.</param>
        /// <param name="templates">Names of templates to use during Plan.</param>
        /// <param name="applyResult">Apply lowest cost Plan result automatically.  If not specified, no results are applied..</param>
        /// <param name="presses">(Deprecated) Names of presses to use during Plan.</param>
        public PlanResource(int? idref = default(int?), List<string> products = default(List<string>), List<string> profiles = default(List<string>), List<ImpositionAiProfileEntity> profilesInline = default(List<ImpositionAiProfileEntity>), int? stopMinutes = default(int?), List<string> things = default(List<string>), List<SheetRefEntity> sheets = default(List<SheetRefEntity>), List<SheetRefEntity> rolls = default(List<SheetRefEntity>), List<string> templates = default(List<string>), bool? applyResult = default(bool?), List<string> presses = default(List<string>))
        {
            this.Idref = idref;
        ...
        /// </summary>
        /// <value>Names of things to use during Plan</value>
        ...
        /// </summary>
        /// <value>Sheets to use during Plan</value>
        ...
        /// </summary>
        /// <value>Rolls to use during Plan</value>
        ...
        /// </summary>
        /// <value>Names of templates to use during Plan</value>
        ...
        /// </summary>
        /// <value>Apply lowest cost Plan result automatically.  If not specified, no results are applied.</value>
        [DataMember(Name="apply-result", EmitDefaultValue=false)]
        public bool? ApplyResult { get; set; }

        /// <summary>
        /// (Deprecated) Names of presses to use during Plan
        /// </summary>
        /// <value>(Deprecated) Names of presses to use during Plan</value>
        ...
        {
            return this.Equals(input as PlanResource);
        }

        /// <summary>
        /// Returns true if PlanResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PlanResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlanResource input)
        {
            if (input == null)
                return false;
