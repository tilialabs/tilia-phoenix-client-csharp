...
{
    /// <summary>
    /// Flatbed die cutter capabilities
    /// </summary>
    [DataContract]
        public partial class FdcCapabilities :  IEquatable<FdcCapabilities>, IValidatableObject
    {
        /// <summary>
        /// Limit logic
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FdcCapabilities" /> class.
        /// </summary>
        ...
        public FdcCapabilities(ScalarRange widthRange = default(ScalarRange), ScalarRange heightRange = default(ScalarRange), bool? limit = default(bool?), LimitLogicEnum limitLogic = default(LimitLogicEnum), ScalarRange caliperRange = default(ScalarRange), StockWeightRange weightRange = default(StockWeightRange), SheetHandlingEnum sheetHandling = default(SheetHandlingEnum), DctcapabilitiesStocktypes stockTypes = default(DctcapabilitiesStocktypes), DctcapabilitiesStocktypes specificStocks = default(DctcapabilitiesStocktypes), TypeEnum type = default(TypeEnum))
        {
            ...
            if (heightRange == null)
            {
                throw new InvalidDataException("heightRange is a required property for FdcCapabilities and cannot be null");
            }
            else
            {
            ...
            if (limit == null)
            {
                throw new InvalidDataException("limit is a required property for FdcCapabilities and cannot be null");
            }
            else
            {
                this.Limit = limit;
            ...
            if (limitLogic == null)
            {
                throw new InvalidDataException("limitLogic is a required property for FdcCapabilities and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("caliperRange is a required property for FdcCapabilities and cannot be null");
            }
            else
            {
            ...
            if (weightRange == null)
            {
                throw new InvalidDataException("weightRange is a required property for FdcCapabilities and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sheetHandling is a required property for FdcCapabilities and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for FdcCapabilities and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FdcCapabilities {\n");
        ...
        {
            return this.Equals(input as FdcCapabilities);
        }

        /// <summary>
        /// Returns true if FdcCapabilities instances are equal
        /// </summary>
        /// <param name="input">Instance of FdcCapabilities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FdcCapabilities input)
        {
            if (input == null)
                return false;
