...
{
    /// <summary>
    /// Export Cover Sheet action resource
    /// </summary>
    [DataContract]
        public partial class ExportCoverSheetResource :  IEquatable<ExportCoverSheetResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportCoverSheetResource" /> class.
        /// </summary>
        ...
        public ExportCoverSheetResource(int? idref = default(int?), string path = default(string), string preset = default(string))
        {
            this.Idref = idref;
            this.Path = path;
            this.Preset = preset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportCoverSheetResource {\n");
        ...
        {
            return this.Equals(input as ExportCoverSheetResource);
        }

        /// <summary>
        /// Returns true if ExportCoverSheetResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportCoverSheetResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportCoverSheetResource input)
        {
            if (input == null)
                return false;
