...
namespace TiliaLabs.Phoenix.Model
{
    ...
    public abstract class PartObject :  IEquatable<PartObject>, IValidatableObject
    {
        ...
        public PartObject(string name = default(string), GrainEnum grain = default(GrainEnum), List<Page> pages = default(List<Page>), List<ProcessSetting> processSettings = default(List<ProcessSetting>), Rotation rotation = default(Rotation), Material material = default(Material), List<Process> processes = default(List<Process>))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PartObject and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (grain == null)
            {
                throw new InvalidDataException("grain is a required property for PartObject and cannot be null");
            }
            else
            {
                this.Grain = grain;
            ...
            if (pages == null)
            {
                throw new InvalidDataException("pages is a required property for PartObject and cannot be null");
            }
            else
            {
                this.Pages = pages;
            ...
            {
                throw new InvalidDataException("processSettings is a required property for PartObject and cannot be null");
            }
            else
            {
            ...
            if (rotation == null)
            {
                throw new InvalidDataException("rotation is a required property for PartObject and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PartObject);
        }

        /// <summary>
        /// Returns true if PartObject instances are equal
        /// </summary>
        /// <param name="input">Instance of PartObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartObject input)
        {
            if (input == null)
                return false;
