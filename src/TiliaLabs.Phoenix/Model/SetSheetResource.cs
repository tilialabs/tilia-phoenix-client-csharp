...
{
    /// <summary>
    /// Set sheet action resource
    /// </summary>
    [DataContract]
        public partial class SetSheetResource :  IEquatable<SetSheetResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetSheetResource" /> class.
        /// </summary>
        ...
        /// <param name="name">Name of sheet within stock to use.</param>
        public SetSheetResource(int? idref = default(int?), string stock = default(string), string grade = default(string), string name = default(string))
        {
            this.Idref = idref;
            this.Stock = stock;
            this.Grade = grade;
        ...
        /// </summary>
        /// <value>Name of sheet within stock to use</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetSheetResource {\n");
        ...
        {
            return this.Equals(input as SetSheetResource);
        }

        /// <summary>
        /// Returns true if SetSheetResource instances are equal
        /// </summary>
        /// <param name="input">Instance of SetSheetResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetSheetResource input)
        {
            if (input == null)
                return false;
