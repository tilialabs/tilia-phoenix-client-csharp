...
{
    /// <summary>
    /// Bound signature component
    /// </summary>
    [DataContract]
        public partial class BoundSignature :  IEquatable<BoundSignature>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoundSignature" /> class.
        /// </summary>
        ...
        /// <param name="foldingPattern">foldingPattern (required).</param>
        ...
        public BoundSignature(DieDesign dieDesign = default(DieDesign), Spacing spacing = default(Spacing), Offcut offcut = default(Offcut), TypeEnum type = default(TypeEnum), AssetInfo foldingPattern = default(AssetInfo), int? total = default(int?), int? placed = default(int?), bool? fulfilled = default(bool?), List<BoundsignatureLayouts> layouts = default(List<BoundsignatureLayouts>), int? overrun = default(int?))
        {
            // to ensure "dieDesign" is required (not null)
            if (dieDesign == null)
            {
                throw new InvalidDataException("dieDesign is a required property for BoundSignature and cannot be null");
            }
            else
            {
            ...
            if (spacing == null)
            {
                throw new InvalidDataException("spacing is a required property for BoundSignature and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BoundSignature and cannot be null");
            }
            else
            {
                this.Type = type;
            }
            // to ensure "foldingPattern" is required (not null)
            if (foldingPattern == null)
            {
                throw new InvalidDataException("foldingPattern is a required property for BoundSignature and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets FoldingPattern
        /// </summary>
        [DataMember(Name="folding-pattern", EmitDefaultValue=false)]
        public AssetInfo FoldingPattern { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BoundSignature {\n");
            ...
            sb.Append("  FoldingPattern: ").Append(FoldingPattern).Append("\n");
        ...
        {
            return this.Equals(input as BoundSignature);
        }

        /// <summary>
        /// Returns true if BoundSignature instances are equal
        /// </summary>
        /// <param name="input">Instance of BoundSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BoundSignature input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FoldingPattern == input.FoldingPattern ||
                    (this.FoldingPattern != null &&
                    this.FoldingPattern.Equals(input.FoldingPattern))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FoldingPattern != null)
                    hashCode = hashCode * 59 + this.FoldingPattern.GetHashCode();
                if (this.Total != null)
