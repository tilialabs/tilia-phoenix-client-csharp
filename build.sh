...
${nuget_cmd} install src/TiliaLabs.Phoenix/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TiliaLabs.Phoenix.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TiliaLabs.Phoenix.dll \
-recurse:'src/TiliaLabs.Phoenix/*.cs' \
-doc:bin/TiliaLabs.Phoenix.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TiliaLabs.Phoenix.dll was created successfully"
fi
